...
class OnlineTest4 extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			label.setText("Que5: Among these options which one is checked exception");
			option[0].setText("compile time");option[1].setText("Run time");option[2].setText("Error");option[3].setText("IOException");
		}
		if(current==5)
		{
